  ...
  return (
    <form method="get" action={basePath} className="sticky top-14 z-30 mb-4 border-y bg-[var(--header)] py-2 backdrop-blur-xl sm:rounded-lg sm:border sm:px-2">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Select name="platform" value={filters.platform} label="Platform"><option value="all">All platforms</option><option value="kalshi">Kalshi</option><option value="polymarket">Polymarket</option></Select>
