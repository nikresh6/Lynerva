  ...
  return (
    <form method="get" action={basePath} className="sticky top-14 z-30 mb-4 border-y bg-[var(--header)] py-2 backdrop-blur-xl sm:rounded-lg sm:border sm:px-2">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Select name="type" value={filters.family} label="Market type"><option value="all">All markets</option><option value="moneyline">Moneyline</option><option value="passing_yards">Passing yards</option><option value="passing_touchdowns">Passing TDs</option><option value="rushing_yards">Rushing yards</option><option value="receiving_yards">Receiving yards</option><option value="receptions">Receptions</option><option value="touchdowns">Anytime TDs</option></Select>
